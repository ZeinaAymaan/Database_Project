...
<%--                </div>--%>
    ...
    <form id="form1" runat="server">
        <div class="text-center">
            ...
            <br />
            <br />
            <asp:Button ID="RegisterSportsAssociationManagerButton" runat="server" Text="Register Sports Association Manager" OnClick="RegisterSportsAssociationManagerButton_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
